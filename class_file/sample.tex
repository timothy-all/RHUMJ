...
\email{u-kid@ancient-greece.biz}
...
\begin{document}
\abstract{Insert your abstract here. The abstract should be a short paragraph that details what the current paper sets out to do, and a high-level description of how it goes about what it does. Also, you should avoid putting citations, like this one \cite{eulogy}, in the abstract.}
